# Update Team Score
execute if entity @s[team=Red] run scoreboard players set Item4 teamRedScore 1
execute if entity @s[team=Gold] run scoreboard players set Item4 teamGoldScore 1
execute if entity @s[team=Blue] run scoreboard players set Item4 teamBlueScore 1
execute if entity @s[team=Magenta] run scoreboard players set Item4 teamMagentaScore 1
execute if entity @s[team=Black] run scoreboard players set Item4 teamBlackScore 1
execute if entity @s[team=Green] run scoreboard players set Item4 teamGreenScore 1
...
$execute if score deleteItemOnPickup gameOptions matches 1 if entity @s[tag=!Item4] run clear @s $(Id) 1

# Add tag to Player in Team
execute if entity @s[team=Red] run tag @a[team=Red] add Item4
execute if entity @s[team=Gold] run tag @a[team=Gold] add Item4
execute if entity @s[team=Blue] run tag @a[team=Blue] add Item4
execute if entity @s[team=Magenta] run tag @a[team=Magenta] add Item4
execute if entity @s[team=Black] run tag @a[team=Black] add Item4
execute if entity @s[team=Green] run tag @a[team=Green] add Item4